...
# ─── PWA / Startscherm icon ──────────────────────────────────────────────────
try:
    from carboo_assets import MASCOT_B64 as _CARBOO_ICON_B64
except:
    _CARBOO_ICON_B64 = ""

st.markdown(f"""
<link rel="apple-touch-icon" href="data:image/png;base64,{_CARBOO_ICON_B64}">
<link rel="icon" type="image/png" href="data:image/png;base64,{_CARBOO_ICON_B64}">
