...
<title>Carboo — Sports Nutrition Coach</title>
...
<nav>
  ...
  <div class="nav-right">
    <a href="/?actie=register" target="_top" class="nav-login">Inloggen</a>
    <a href="/?actie=register" target="_top" class="btn-cta">Gratis starten →</a>
  </div>
</nav>
...
<section class="hero">
  <div>
    ...
    <div class="hero-cta">
      <a href="/?actie=register" target="_top" class="btn-primary">Gratis starten →</a>
...
<section class="cta-sectie">
  ...
  <a href="/?actie=register" target="_top" class="btn-dark">Gratis starten →</a>
  <div class="cta-proof">
